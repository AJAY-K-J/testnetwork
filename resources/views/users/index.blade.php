...
<section class="hero-area">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    <h1 class="wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".3s">Routing You <br> To Success</h1>
                    ...
                    <ul class="list-inline wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".7s">
                        ...
                        <li class="list-inline-item">
                            <a data-scroll a href="tel:+91 9747 51 2223"  class="btn btn-transparent btn-outline-dark">Call Now</a>
                        </li>
                    </ul>
                </div>
            </div>
  ...
  <div class="container">
    ...
    <h2>Why Network Academy</h2>
          ...
          <p class="p-100"><b>Network Academy Mankavu, Calicut</b> is a premier educational institution with an innovative effort keeping in view of this new demand of the hi-tech new age, delivering information and communication technology skills in its precise and relevant formats. Network Academy’s proven track of quality end academic training program has been noted for its highly-qualified faculty, career oriented training system and the best infrastructure in the field of computer networking and software imparting premium training in the areas of Inter networking Technologies, Operating Systems, Web Servers and Security/Firewalls.
            Our professional training will help students to strengthen their soft skills and interviewing skills. Our courses enable students to get world-recognized certifications from leading global players like Cisco, Microsoft, and Red hat.</p>
...
<section class="blog" id="blog">
	<div class="container">
		<div class="row">
			...
			<div class="col-12">
				<div class="title text-center ">
					<h2> Courses <span class="color">Offered</span></h2>
					<div class="border"></div>
				</div>
			</div>
			<!-- /section title -->
...
<div style="min-height: 200px;">
						<h3 style="font-size: 16px;"><a href="#">Hardware Mcitp Mcsa Mcse Packages Rhce Rhcsa
                            Cisco Certified Internetwork Expert (CCIE)</a></h3>
						<p class="text-justify">This certification validates the ability to plan, implement, verify and troubleshoot local and wide-area enterprise networks and work collaboratively with specialists on advanced security, voice, wireless and video solutions. </p></div>
			...
			<article class="col-md-4 col-sm-6 col-xs-12 ">
				<div class="post-item">
					...
					<div class="content" >
<div style="min-height: 200px">
						<h3 style="font-size: 16px;"><a href="#">Cisco Certified Network Professional (CCNP Routing And Switching)</a></h3>
						<p class="text-justify">This certification validates the ability to plan, implement, verify and troubleshoot local and wide-area enterprise networks and work collaboratively with specialists on advanced security, voice, wireless and video solutions</p></div>
						<a class="btn btn-main" href="single-post.html">Read more</a>
			...
			<article class="col-md-4 col-sm-6 col-xs-12 ">
				<div class="post-item">
					...
					<div class="content">
                        <div style="min-height: 200px;">
						<h3 style="font-size: 16px"><a href="single-post.html">Cisco Certified Network Professional Collaboration(CCNP Collaboration)</a></h3>
						<p class="text-justify">For collaboration and unified communications network engineers who want develop advanced collaboration skills designing, deploying, configuring, and troubleshooting Cisco Collaboration and Unified communications applications, devices and networks, the Cisco CCNP </p></div>
						<a class="btn btn-main" href="single-post.html">Read more</a>
					</div>
				</div>
			</article>
...
<!-- end team member -->
            ...
            <div class="text-center mt-5 pb-1"><a class="btn btn-main" href="#">View More</a></div>
        </section> <!-- End section -->
                    ...
                    <div id="recipeCarousel" class="carousel slide w-100" data-ride="carousel">
                        <div class="carousel-inner w-100" role="listbox">
                            <div class="carousel-item row no-gutters active mb-5">
                                <div class="col-3 float-left"><img class="img-fluid" src="images/BrandSlides/cisco.png" width="150px"></div>
                                <div class="col-3 float-left"><img class="img-fluid" src="images/BrandSlides/redhat.png" width="200px"></div>
                                <div class="col-3 float-left"><img class="img-fluid" src="images/BrandSlides/vm.png" width="200px"></div>
                                <div class="col-3 float-left"><img class="img-fluid" src="images/BrandSlides/sun.png" width="160px"></div>

                            </div>
                            <div class="carousel-item row no-gutters mb-5">
                                <div class="col-3 float-left"><img class="img-fluid" src="images/BrandSlides/citrix.png" width="160px"></div>
                                <div class="col-3 float-left"><img class="img-fluid" src="images/BrandSlides/micro.png" width="180px"></div>
								<div class="col-3 float-left"><img class="img-fluid" src="images/BrandSlides/redhat.png" width="200px"></div>
                                <div class="col-3 float-left"><img class="img-fluid" src="images/BrandSlides/vm.png" width="200px"></div>
                            </div>
                        </div>
